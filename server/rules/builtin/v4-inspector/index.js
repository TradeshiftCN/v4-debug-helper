...
const shouldInspect = url => ConfigService.getRuleV4InspectorConfig().inspectUrls.some(urlConfig => urlConfig.enabled && urlConfig.pattern && new RegExp(urlConfig.pattern).test(url));
